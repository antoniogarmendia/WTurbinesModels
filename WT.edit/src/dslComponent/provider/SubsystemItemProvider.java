...
/**
 * This is the item provider adapter for a {@link dslComponent.Subsystem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubsystemItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 dslComponentPackage.Literals.SUBSYSTEM__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 dslComponentPackage.Literals.SUBSYSTEM__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(dslComponentPackage.Literals.SUBSYSTEM__BEH);
			childrenFeatures.add(dslComponentPackage.Literals.SUBSYSTEM__COMPONENTS);
			childrenFeatures.add(dslComponentPackage.Literals.SUBSYSTEM__SUBSYSTEMS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(dslComponentPackage.Literals.SUBSYSTEM__BEH,
				 dslComponentFactory.eINSTANCE.createControlSubsystem()));

		newChildDescriptors.add
			(createChildParameter
				(dslComponentPackage.Literals.SUBSYSTEM__COMPONENTS,
				 dslComponentFactory.eINSTANCE.createComponent()));

		newChildDescriptors.add
			(createChildParameter
				(dslComponentPackage.Literals.SUBSYSTEM__SUBSYSTEMS,
				 dslComponentFactory.eINSTANCE.createSubsystem()));
	}
