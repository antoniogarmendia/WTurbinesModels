...
package wt.modular.wizard.file;
...
public class ComponentCreateFileWizard extends Wizard implements INewWizard {
	private ComponentCreateFileWizardPage page;
	private ISelection selection;

	/**
	 * Constructor for ComponentCreateFileWizard.
	 */
	public ComponentCreateFileWizard() {
		super();
	...
	public void addPages() {
		page = new ComponentCreateFileWizardPage(selection);
		addPage(page);
	}
	...
	private void doFinish(
		...
		Component rootObject = dslComponentFactoryImpl.eINSTANCE.createComponent();

		//Set the Attributes
			rootObject.setId(attr_id);
			rootObject.setName(fileName);
		...
		((EList<EObject>)file_xmi.Get_Root().eGet(file_xmi.Get_Root().eClass().getEStructuralFeature("components"), true)).add(child_xmi.Get_Root());
		file_xmi.Save_XMI();
