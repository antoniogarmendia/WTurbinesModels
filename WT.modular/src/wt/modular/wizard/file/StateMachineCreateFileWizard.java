...
public class StateMachineCreateFileWizard extends Wizard implements INewWizard {
	...
	private void doFinish(
		...
		StateMachine rootObject = dslComponentFactoryImpl.eINSTANCE.createStateMachine();
		...
		((EList<EObject>)file_xmi.Get_Root().eGet(file_xmi.Get_Root().eClass().getEStructuralFeature("machines"), true)).add(child_xmi.Get_Root());
		file_xmi.Save_XMI();
