...
public class ComponentFilter implements IObtainClassFeatures{

	@Override
	public EClass GetEClass() {
		// TODO Auto-generated method stub
		return dslComponentPackage.eINSTANCE.getComponent();
	}
	...
	public EList<EStructuralFeature> GetEStructuralFeature() {
		...
		list_feat.add(GetEClass().getEStructuralFeature("ports"));
