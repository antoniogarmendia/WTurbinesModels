...
public class StateMachineFilter implements IObtainClassFeatures{

	@Override
	public EClass GetEClass() {
		// TODO Auto-generated method stub
		return dslComponentPackage.eINSTANCE.getStateMachine();
	}
	...
	public EList<EStructuralFeature> GetEStructuralFeature() {
		...
		list_feat.add(GetEClass().getEStructuralFeature("states"));
		list_feat.add(GetEClass().getEStructuralFeature("transitions"));
		return list_feat;		
	}
