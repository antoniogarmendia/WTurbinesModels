...
public class VertexFilter implements IObtainClassFeatures{

	@Override
	public EClass GetEClass() {
		// TODO Auto-generated method stub
		return dslComponentPackage.eINSTANCE.getVertex();
	}
	...
	public EList<EStructuralFeature> GetEStructuralFeature() {
		...
		list_feat.add(GetEClass().getEStructuralFeature("outgoing"));
