...
public class EdgeFilter implements IObtainClassFeatures{

	@Override
	public EClass GetEClass() {
		// TODO Auto-generated method stub
		return dslComponentPackage.eINSTANCE.getEdge();
	}
	...
	public EList<EStructuralFeature> GetEStructuralFeature() {
		...
		list_feat.add(GetEClass().getEStructuralFeature("source"));
		list_feat.add(GetEClass().getEStructuralFeature("target"));
		return list_feat;		
	}
